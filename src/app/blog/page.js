                                        ...
                                        <div className="post-section-inner">
                                            <div className="row g-5">
                                                <div className="col-lg-12">
                                                    <div className="eblog-featured-news style-two big">
                                                        <div className="image-area">
                                                            <Link href="#"><img src="/images/blog/26.jpg" alt="" /></Link>
                                                        ...
                                                        <div className="blog-content">
                                                            ...
                                                            <h4 className="heading-title"><Link className="title-animation text-center" href="#">We Spent Hours Finding The Best <br /> Dresses of 2024—Here Are the Top 57</Link></h4>
                                                            <Link href="#" className="text-btn color-two">Continue Reading</Link>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div className="col-lg-12">
                                                    <div className="eblog-featured-news style-two big">
                                                        <div className="image-area">
                                                            <Link href="#"><img src="/images/blog/154.jpg" alt="" /></Link>
                                                            <p className="tag">Freedom</p>
                                                        </div>
                                                        <div className="blog-content">
                                                            <ul className="blog-meta">
                                                            ...
                                                            <h4 className="heading-title"><Link className="title-animation text-center" href="#">5 Efficient Rules How to Organize
                                                                Your <br /> Working Place Relationship</Link></h4>
                                                            <Link href="#" className="text-btn color-two">Continue Reading</Link>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div className="col-lg-12">
                                                    <div className="eblog-featured-news style-two big">
                                                        <div className="image-area">
                                                            <Link href="#"><img src="/images/blog/155.jpg" alt="" /></Link>
                                                            <p className="tag">Freedom</p>
                                                        </div>
                                                        <div className="blog-content">
                                                            <ul className="blog-meta">
                                                ...
                                                <div className="col-lg-12">
                                                    <div className="eblog-featured-news style-two big">
                                                        <div className="image-area">
                                                            <Link href="#"><img src="/images/blog/156.jpg" alt="" /></Link>
                                                            <p className="tag">Freedom</p>
                                                        </div>
                                                        <div className="blog-content">
                                                            <ul className="blog-meta">
                                                ...
                                                <div className="col-lg-12">
                                                    <div className="eblog-featured-news style-two big">
                                                        <div className="image-area">
                                                            <Link href="#"><img src="/images/blog/157.jpg" alt="" /></Link>
                                                            <p className="tag">Freedom</p>
                                                        </div>
                                                        <div className="blog-content">
                                                            <ul className="blog-meta">
                                    ...
                                    <div className="eblog-right-side-post feature">
                                        ...
                                        <div className="featured-post sidebar">
                                            ...
                                            <div className="blog-content">
                                                ...
                                                <h5 className="heading-title"><Link className="title-animation" href="#">So Long, Winter: These Are The <br /> 7 Best Trends of Spring 2024</Link></h5>
                                    ...
                                    <div className="eblog-right-side-post popular">
                                        ...
                                        <div className="small-post">
                                            <div className="eblog-post-list-style">
                                                <div className="image-area">
                                                    <Link href="#"><img src="/images/blog/45.jpg" alt="" /></Link>
                                                </div>
                                                <div className="blog-content">
                                                    <h4 className="heading-title"><Link className="title-animation" href="#">The Lazy Girl’s Guide to Always Put Together</Link></h4>
                                                    <ul className="blog-meta">
                                                        <li>
                                                            <svg width="15" height="15" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            ...
                                            <div className="eblog-post-list-style">
                                                <div className="image-area">
                                                    <Link href="#"><img src="/images/blog/46.jpg" alt="" /></Link>
                                                </div>
                                                <div className="blog-content">
                                                    <h4 className="heading-title"><Link className="title-animation" href="#">The Everygirl’s Spring 2024 Capsule Wardrobe</Link></h4>
                                                    <ul className="blog-meta">
                                                        <li>
                                                            <svg width="15" height="15" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            ...
                                            <div className="eblog-post-list-style">
                                                <div className="image-area">
                                                    <Link href="#"><img src="/images/blog/47.jpg" alt="" /></Link>
                                                </div>
                                                <div className="blog-content">
                                                    <h4 className="heading-title"><Link className="title-animation" href="#">7 Wardrobe Staples Thats Are Better Secondhand</Link></h4>
                                                    <ul className="blog-meta">
                                                        <li>
                                                            <svg width="15" height="15" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            ...
                                            <div className="eblog-post-list-style">
                                                <div className="image-area">
                                                    <Link href="#"><img src="/images/blog/48.jpg" alt="" /></Link>
                                                </div>
                                                <div className="blog-content">
                                                    <h4 className="heading-title"><Link className="title-animation" href="#">Apple introduces sustainable repair options with used</Link></h4>
                                                    <ul className="blog-meta">
                                                        <li>
                                                            <svg width="15" height="15" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <div className="eblog-right-side-post category2">
                                        ...
                                        <div className="category-area">
                                            <ul className="category-wrapper">
                                                <li>
                                                    <div className="image-area">
                                                        <Link href="#"><img src="/images/category/category-04.jpg" alt="" /></Link>
                                                        <p className="text"><Link href="#">Fashion</Link></p>
                                                    </div>
                                                </li>
                                                <li>
                                                    <div className="image-area">
                                                        <Link href="#"><img src="/images/category/category-05.jpg" alt="" /></Link>
                                                        <p className="text"><Link href="#">Life Style </Link></p>
                                                    </div>
                                                </li>
                                                <li>
                                                    <div className="image-area">
                                                        <Link href="#"><img src="/images/category/category-06.jpg" alt="" /></Link>
                                                        <p className="text"><Link href="#">Travel</Link></p>
                                                    </div>
                                                </li>
                                            </ul>
                                        </div>
