...
import { SuspenseWrapper } from "@/Components/Loader";
...
export const metadata = {
  ...
  description:
    "Explore hot topics, blogs related to gadgets, artificial intelligence and current technology trends - techfacts central.",
  keywords:
    "techfacts central blogs, latest technology trends, technology posts",
  author: "Sparsh Pandya",
  openGraph: {
    title: "Blog | Techfacts Central",
    description:
      "Explore our blog page and get engaged with new blogs everyday - techfacts central.",
  },
};
                      ...
                      <div className="row g-5">
                          ...
                          <div className="eblog-featured-news style-two big">
                            {allPosts && allPosts.length > 0 ? (
                              allPosts.map(async (post) => {
                                ...
                                return (
                                  <>
                                    <SuspenseWrapper component={<PostsLoader />}>
                                      ...
                                      <div className="blog-content">
                                        ...
                                        <h4 className="heading-title">
                                          <Link
                                            className="title-animation text-center"
                                            href="#"
                                          >
                                            {title} - {category}
                                          </Link>
                        ...
                        <div className="col-lg-12">
                          <div className="button-area">
                            <Link
                              href="#"
                              className="tp-btn btn-secondary m-auto"
                            >
                              Load More
                            </Link>
                          </div>
